...
GLuint loadTexture(GLchar *path, bool gamma_correction);
...
int main()
{
	...
	// load textures
	// -------------
	GLuint floorTexture = loadTexture("wood.jpg", false);
	GLuint floorTextureGammaCorrected = loadTexture("wood.jpg", true);

	// shader configuration
	// --------------------
	shader.Use();
	glUniform1i(glGetUniformLocation(shader.Program, "floorTexture"), 0); //looks like setting texture value to 0
	  //like no texture
